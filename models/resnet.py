...
class ResNet(nn.Module):
    def __init__(self, block, layers, low_dim=1024, in_channel=3, width=1):
        self.inplanes = 64
...
class ResNetT2(nn.Module):
    def __init__(self):
        ...
        self.visual_touch = resnet18(in_channel=6, width=1.0)
    def forward(self, x, mode):
        return self.visual_touch(x, mode)

class MyResNetsCMC(nn.Module):
    def __init__(self, args):
        super(MyResNetsCMC, self).__init__()
        self.encoder = ResNetT2()
